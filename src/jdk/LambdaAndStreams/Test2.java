...
public class Test2 {
    public static void main(String[] args) {
        List<Person> javaProgrammers = new ArrayList<Person>() {
            {
                ...
                add(new Person("Maude", "Jaimie", "Java programmer", "female", 27, 19000));
        ...
        List<Person> phpProgrammers = new ArrayList<Person>() {
            {
                ...
                add(new Person("Rosalind", "Layla", "PHP programmer", "female", 25, 13000));
        ...
        System.out.println("下面是年龄大于" +
                " 24岁且月薪在$1,400以上的女PHP程序员:");
        phpProgrammers.stream()
                .filter(ageFilter)
                .filter(salaryFilter)
                .filter(genderFilter)
